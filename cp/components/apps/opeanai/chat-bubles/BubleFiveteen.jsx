import { cls27, cls26, cls25, cls24, cls23, cls16, cls13, cls11, cls10, cls9, cls33, cls30, cls28, cls29 } from "../cls"
const BubleFiveteen = ({}) => {
  return (
    <>
      {/*<!-- Chat Bubble -->*/}
        ...
        <div className={cls23}>
          ...
          <div className={cls11}>
            <p className={cls16}>
              ...
              frameworks like Bootstrap, it does not provide a series of predefined classes for elements such as buttons
              or tables.
            </p>
            <div className={cls13}>
              <ul>
