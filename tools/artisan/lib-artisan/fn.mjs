...
const showHelp = (availables, moduleActions) => {
  ...
  const helps = Object.keys(availables)
    .filter((item) => !item.match(/_\d+$/))
    .map((actionName) => {
...
export { importActionModules, showHelp, getActionArgs, processAction, getFlagArgs, snakeToCamel, camelToSnake }
