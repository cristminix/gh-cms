...
const UserForm = ({
  ...
  const saveForm = async (f) => {
    ...
    const url = apiUrl(["cms-user", pk ? `update/${pk}` : "create"])
        ...
        <div className="hs-overlay-open:opacity-100 hs-overlay-open:duration-500 opacity-0 transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto ]">
          <div className="flex w-[700px] flex-col bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]">
            <div className="flex justify-between items-center py-3 px-4 border-b dark:border-gray-700">
              <h3 className="font-bold text-gray-800 dark:text-white">{username}</h3>
              <button
                type="button"
                id={`${modalCloseBtnId}`}
            ...
            <div className="p-4 overflow-y-auto">
              <form className={"className"} ref={formRef}>
                ...
                />
                <div className="p-2 font-bold text-center italic">Name</div>
                ...
                <FormRowSelect
                  ...
                  value={groupId}
                  fieldname="groupId"
                  url={apiUrl("cms-user-group/dropdown")}
                  onChange={(e) => {
                    setGroupId(e)
                  }}
                />
