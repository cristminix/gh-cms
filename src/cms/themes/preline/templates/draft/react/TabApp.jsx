 ...
 const TabApp = ({})=>{
   ...
   <button type="button" id="bar-with-underline-item-1" data-hs-tab="#bar-with-underline-1" aria-controls="bar-with-underline-1" role="tab" className={cls1}> 
    Tab 1
   </button> 
   <button type="button" id="bar-with-underline-item-2" data-hs-tab="#bar-with-underline-2" aria-controls="bar-with-underline-2" role="tab" className={cls2}> 
    Tab 2
   </button> 
   <button type="button" id="bar-with-underline-item-3" data-hs-tab="#bar-with-underline-3" aria-controls="bar-with-underline-3" role="tab" className={cls2}> 
    Tab 3
   </button> 
 </nav> 
