  ...
  const router = createHashRouter(
    createRoutesFromElements(
      <Route path="/" errorElement={<ErrorPage />} element={<Template config={config} store={store} />}>
        ...
        <Route path="/apps" element={<NativeClientApp store={store} config={config} />} loader={ncAppLoader} />
        <Route path="/apps/:module" element={<NativeClientApp store={store} config={config} />} loader={ncAppLoader} />
        <Route path="/apps/:module/page/:pageNumber" element={<NativeClientApp store={store} config={config} />} loader={ncAppLoader} />
        <Route path="/apps/:module/:fk" element={<NativeClientApp store={store} config={config} />} loader={ncAppLoader} />
        <Route path="/apps/:module/:fk/page/:pageNumber" element={<NativeClientApp store={store} config={config} />} loader={ncAppLoader} />
