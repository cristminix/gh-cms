...
class DownloadWizard extends Component {
  ...
  render() {
    ...
    return (
      <>
        <div className={`border rounded-xl shadow-sm p-6 dark:bg-gray-800 dark:border-gray-700 ${className}`}>
          {stage === 1 ? (
            <>
              <div className="flex p-2 flex-col">
                <div className="flex">
                  <span className={`${thCls}`}>Url</span>
                  <span>
                    <p title={url} className="w-[500px] text-elipsis overflow-hidden ...">
                      {url}
                    </p>
                  </span>
                </div>
                ...
                <div className="flex">
                  <span className={`${thCls}`}>Status Code</span>
                  <span>{statusCode}</span>
                </div>

                <div className="flex">
                  <span className={`${thCls}`}>Filename</span>
                  <span>{filename}</span>
                </div>
                <div className="flex">
                  <span className={`${thCls}`}>Type</span>
                  <span>{mime}</span>
                </div>
                {size ? (
                  <div className="flex">
                    <span className={`${thCls}`}>Size</span>
