      ...
      <div className="course-display flex gap-2 mb-2 bg-gray-50 dark:bg-slate-800 p-4">
        {thumbnailUrl ? (
          <div
            ...
            className={`flex-none min-h-[128px] w-[256px] bg-cover thumbnail-container rounded rounded-md  `}
          ></div>
        ) : null}
        <div className="">
          <div className="pl-2">
            <div>
              <h4 className="text-2xl">
                {" "}
                <a className="" href={`#/manager/${course.slug}`}>
                  {course.title}
                </a>
              </h4>
            ...
            >
              ...
              <div className="mt-3 text-sm leading-6 text-slate-600 dark:text-slate-400">
                <p>
                  Start by{" "}
                  <a
                    className="text-blue-600 hover:text-blue-500 opacity-90 font-bold"
                    href="https://www.linkedin.com/learning"
                    target="_blank"
                  >
                    <i className="fa fa-external-link" /> Browse LinkedIn
                    Learning
                  </a>{" "}
