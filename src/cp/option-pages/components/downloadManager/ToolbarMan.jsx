...
import { createDownloadFile } from "@/cp/global/fn"
             ...
             */}
                ...
                {dmsetup && !reconfigureSetup ? (
                  <>
                    ...
                    <Button
                      onClick={(e) => downloadPlaylist(e)}
                      className=""
                      caption="Playlist.m3u"
                      icon="bi bi-collection-play"
                    />
                    <Button
                      onClick={(e) => downloadHelper(e)}
                      className=""
                      caption="Helper.sh"
                      icon="bi bi-terminal-fill"
                    />
                    <Button
                      onClick={(e) => downloadHelperCmd(e)}
                      className=""
                      caption="Helper.cmd"
                      icon="bi bi-terminal"
                    />
                    ...
                    <DropdownMenu
                      className={`p-0`}
                      data={ddToolbarData}
                      onSelect={(e) => onSelectDdToolbar(e)}
                      labelIcon="fa fa-cog"
                    />
                  </>
                ) : (
              ...
              <>
                {!runSetup ? (
                  <Button
                    ...
                    onMouseOver={(e) =>
                      logStatusBar("ToolbarMan", `Run Setup Queue`)
                    }
